...
public class RestaurantTestData {
    ...
    public static final Menu MENU_1 = new Menu(MENU_1_ID, TODAY, RESTAURANT_1, DISH_1, DISH_2, DISH_3);
    public static final Menu MENU_2 = new Menu(MENU_2_ID, TODAY, RESTAURANT_2, DISH_4, DISH_5, DISH_6);
    public static final Menu MENU_3 = new Menu(MENU_3_ID, YESTERDAY, RESTAURANT_1, DISH_7, DISH_8, DISH_9);
    public static final Menu MENU_4 = new Menu(MENU_4_ID, YESTERDAY, RESTAURANT_2, DISH_10, DISH_11, DISH_12);
